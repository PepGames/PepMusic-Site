...
export const metadata: Metadata = { title: "Privacy | PepMusic", description: "PepMusic privacy notice." };

export default function PrivacyPage() {
  return (
    <main><SiteHeader compact /><article className="legal-page section-shell">
      <p className="eyebrow">PEPMUSIC</p><h1>Privacy</h1><p className="legal-updated">Last updated August 7, 2026</p>
      ...
      <h2>Changes</h2><p>This notice will be updated before accounts, email collection, embedded players, optional analytics, or other data-collecting features are added.</p>
